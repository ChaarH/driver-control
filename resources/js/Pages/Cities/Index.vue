                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {{ useMoneyFormat(city.trip_price) }}
                      </td>

                      <td
                          class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"
                      >
                        {{ city.increase_time_start }}
                      </td>

                      <td
                          class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"
                      >
                        {{ city.increase_time_end }}
                      </td>

                      <td
                          class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"
                      >
                        {{ useMoneyFormat(city.trip_price_increased_after_time) }}
                      </td>
...
let citiesUrl = computed(() => {
  const url = new URL(route("cities.index"));
...
const deleteUser = (id) => {
  if (confirm("Are you sure you want to delete this student?")) {
    deleteForm.delete(route("cities.destroy", id), {
      preserveScroll: true,
    });
  }
};
