                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div class="flex">
                          <img class="w-7 h-7 rounded-full" :src="trip.driver_info.user.avatar" >
                          <span class="pl-2 pt-1">
                            {{ trip.driver_info.user.name }}
                          </span>
                        </div>
                        <span class="pl-9 text-sm text-gray-400">{{ trip.driver_info.car_brand }}</span>
                      </td>
                      <td
                          class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"
                      >
                        {{ useMoneyFormat(trip.price) }}
                      </td>
                      <td
                          class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"
                      >
                        <BadgeBoolean :text="trip.ended_at === null ? 'Em andamento' : 'Encerrada'" :value="trip.deleted_at === null ? true : false" />
                      </td>
                      <td
                          class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"
                      >
...
let usersUrl = computed(() => {
  const url = new URL(route("trips.index"));
...
const deleteUser = (id) => {
  if (confirm("Are you sure you want to delete this student?")) {
    deleteForm.delete(route("trips.destroy", id), {
      preserveScroll: true,
    });
  }
};
